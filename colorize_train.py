...
def main(args):
    ...
    filenames = get_paths(args.data_dir, int(args.max_images))

    # open model file, build graph
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='colorize_train.py: train the network')
    parser.add_argument('-d', '--data_dir',
            help='where the training pictures are localted',
            required=False,
            default='.')
